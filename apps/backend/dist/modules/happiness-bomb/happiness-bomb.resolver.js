...
let HappinessBombResolver = class HappinessBombResolver {
    ...
    async createHappinessBomb(creatorId, createHappinessBombInput) {
        const input = {
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)('creatorId')),
    __param(1, (0, graphql_1.Args)('createHappinessBombInput')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_happiness_bomb_input_1.CreateHappinessBombInput]),
    __metadata("design:returntype", Promise)
